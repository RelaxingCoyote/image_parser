...
class ImageParser():
    ...
    def write_to_json(self,file_directory,field_name,item_name,item_description="",object_type='figure'):
        item = {f'{object_type}_id':item_name,'describe':item_description}
    ...
    def get_fig_n_below(self,fig_block,image_path,figures_path):
        ...
        self.write_to_json(f"{figures_path}/figures",'figures',fig_num)             
    ...
    def get_table_n(self,fig_block,image_path,figures_path):
        ...
        self.write_to_json(figures_path,table_id,table_description='',object_type='table')
    ...
    def get_desc(self,table_id,table_num,table_text,pattern_desc,figures_path):
        ...
        self.write_to_json(figures_path,table_id,table_description,object_type=sub_branch)
    ...
    def save_table_with_number(self,fig_block,image_path,figures_path):
        ...
        try:
            ...
            table_num, table_text = self.get_table_n(fig_block,image_path,figures_path)
            try:
